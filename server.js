...
const JQL = `project = "CORE PLANs" and status NOT IN (Rejected, Duplicate, Closed, "On Hold") and ("Business Priority[Select List (cascading)]" IN (P0) OR "Quarter[Dropdown]" IN ("Q3 2025 [Jul, Aug, Sept]","Q4 2025 [Oct, Nov, Dec]","Q1 2026 [Jan, Feb, Mar]")) and "Quarter[Dropdown]" != TBD AND ("Ticket Type[Select List (cascading)]" NOT IN (Extension) OR "Ticket Type[Select List (cascading)]" IS EMPTY) ORDER BY cf[10470] ASC, cf[11536] ASC, cf[14375] ASC, cf[13615] ASC, status ASC`;
